...
<header>
  ...
  <div class="menu">
    <ul>
      ...
      <li style="background:#2e2e2e; padding:10px 10px; border:1px solid #000""><a style="background:#161616; padding:9px 9px; border:1px solid #666"" href="studies.php">Case Studies</a></li>
      <li class="selected" style="background:#2e2e2e; padding:10px 10px; border:1px solid #000""><a style="background:#161616; padding:9px 9px; border:1px solid #666" href="index.php">What we do</a></li>
    </ul>
  </div>
</header>
<div class="content">
  ...
  <div class="main-content">
    <h1><span style="color:#bef3ff">What we</span> do </h1>
    <p><img class="dailog" src="#" />Lorem Ipsum is <span style="color:#FFF;">simply dummy text</span> of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1000s,  scrambled it to make a type specimen book. </p>
    <div class="sarfaraz">
